...
namespace TPS_BugTracker.DataLayer.DAOs
{
    public class BugDao
    {
        ...
        public List<Bug> getBugByFilters(List<object> parametros)
        {
        ...
        public bool create(Bug oBug)
        {
            ...
            return BDHelper.getBDHelper().EjecutarSQL(str_sql) == 2;
        }

        public bool updateNewHistorial(List<Bug> lst)
        {
            string str_sql = "";
            HistorialBug oHistorial;
            ...
            return BDHelper.getBDHelper().EjecutarSQL(str_sql) == lst.Count; // NOTAR que será verdadero si y solo se ejecutan exitosamente
        }
